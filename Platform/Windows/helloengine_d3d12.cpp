...
void BuildTorusMesh(float outerRadius, float innerRadius,
...
void CreateDescriptorHeaps(){
    ...
    //SRV (shder resouce view) and constant
...
void InitPipeline(){ 
    ...
    D3DCompileFromFile(L"simple.hlsl",
                        nullptr,
...
void InitGraphics() {
    ...
    {
        ThrowIfFailed(g_pDev->CreateCommittedResource(&CD3DX12_HEAP_PROPERTIES(D3D12_HEAP_TYPE_DEFAULT),
    ...
    //texture is uploaded so we can free the orgin data
    delete [] pTextureData;
}
...
void  CreateGraphicsResource(HWND hWnd){
